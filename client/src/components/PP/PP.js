      ...
      return (
         <div>
            <div className="pp-container">
               <button onClick={this.props.backFromPP} className="pp-btn">
                  Back
               </button>
               <div className="pp">
                  <div className="pp-content">
                     ...
                     <p>
                        ...
                        “myself” all refer to the entity that owns and created
                        the website LGBT Through History, which is the website
                        that the this terms of service agreement refers too.
                     </p>
                     <br />
                     <p>
                        You authorize that I may store any information that you
                        provide to LGBT Through History in any way that I see
                        fit. You authorize that I may use this stored
                        information in order to send messages to email addresses
                        that you provided to LGBT Though History. You authorize
                        Stripe to process your payment information and authorize
